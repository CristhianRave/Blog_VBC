...
class Page(models.Model):
    ...
    image = models.ImageField(verbose_name='Imagen', upload_to="articles", blank=True)
    ...
    categories = models.ManyToManyField(
        Category, verbose_name='Categorias', blank=True)  # Clave ajena de Category
    public = models.BooleanField(verbose_name='Publico', default=True)
    created_at = models.DateTimeField(
        auto_now_add=True, verbose_name='Creado el ')
